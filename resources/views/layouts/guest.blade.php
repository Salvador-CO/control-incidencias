...
<head>
    ...
    <title>{{ config('app.name', 'SICIP') }} - Iniciar Sesión</title>
...
<body>
    <div class="login-wrapper">
        ...
        <div class="text-center mt-4">
            <small class="text-muted" style="font-weight: 500;">&copy; {{ date('Y') }} Sistema Integral de Control de Incidencias del Personal</small>
        </div>
    </div>
